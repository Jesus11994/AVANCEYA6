...
<div id="app-4">  
            ...
            <div class="content container-fluid">
                ...
                <div class="row filter-row">
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-3 col-xl-2 col-12">  
                        <div class="form-group form-focus">
                            <input type="text" class="form-control floating"  v-model="formapellidom"  type="hidden"  >
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
							...
							<div class="form-group">
								...
								<input v-model="informal" id="informal" name="informal"   Class="form-control" type="hidden"  />
		...
		<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
			...
			methods: {
                ...
                //axios.post('http://127.0.0.1:8000/guardarb', arraydatos).then((response)=> {
                    ...
                    if(this.bid != null){
                          //axios.post('http://127.0.0.1:8000/actualiestadop', arraydatos).then((response)=> {
						...
						if (response.data.result) {
							...
							Swal.fire('EL Participante ya confirmo su asistencia');
						}
					 });
