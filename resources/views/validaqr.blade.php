                    ...
                    <div class="col-md-10 mx-auto">
                        <div class="card border-secondary">
                            <div class="card-header">
                                <h3 class="mb-0 my-2" style="text-align:center" >Validación de Constancia de asistencia al 
“5to. Congreso Nacional, Fiscal y Capital Humano 2022 Riviera Maya</h3>
                            </div>
                                                    ...
                                                    <div style="padding-left:20px;">
                                                        ...
                                                        <p class="text-secondary"> <b>Avance Ya Consultores Empresariales,</b> confirma por este medio electrónico, que: <b>{!! $Busqueda->nombre_C !!} {!! $Busqueda->apep_C !!} {!! $Busqueda->apem_C !!}</b> asistió al <b>“5to. Congreso Nacional, Fiscal y Capital Humano 2022 Riviera Maya”.
                                                            ...
                                                            <p class="text-secondary" style="text-align: left"><b>Lugar del Evento :</b> "Teatro de la Ciudad”. Circuito Chinchorro entre Avenida 115 y 120, a un costado de Walmart de la Cruz. Playa del Carmen. Quintana Roo.
                                                                "</p>
                                                                <p class="text-secondary" style="text-align: left">Fechas del evento : 20 y 21 de Enero 2022.</p>
                                                                
                                                                <br>
                                                                <p class="text-secondary" style="text-align: left"><b>Mtro. Pedro Escobedo Vázquez.</b></p>
                                                                <p class="text-secondary" style="text-align: left"><b>Director de Avance Ya  Consultores Empresariales.</b></p>
                                                                
                                                        
                                                                <img class="card-img-top"  src='http://sistema.avanceya.com/constancia/bannerreduc.jpg' />
